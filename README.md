...
-  Completed Stanford/DeepLearning.AI courses: *Supervised Machine Learning: Regression and Classification* and *Neural Networks and Deep Learning*
...
-  Strong backend foundation in **ASP.NET Core, C#, and SQL Server**, which I'm now applying alongside AI/ML work
...
**🛰️ UAV Ballistic Targeting System** *(Research · Scopus-indexed)*
...
** [ChatApplication](https://github.com/fatimalikova/ChatApplication)**
Real-time chat application built to practice live communication patterns and backend event handling.
`C#` `Real-time Communication`

** [htmlLAB2](https://github.com/fatimalikova/htmlLAB2)**
Frontend lab project focused on responsive layout and structured markup.
`HTML` `CSS`
...
- 🔗 LinkedIn: [linkedin.com/fatima.malikova](https://www.linkedin.com/in/fatima-malikova-b00483378?utm_source=share_via&utm_content=profile&utm_medium=member_ios)
